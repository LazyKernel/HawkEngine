...
fn main() {
    ...
    let camera_entity = world
        ...
        .with(Movement {acceleration: 10.0, deceleration: 20.0, max_vel: 500.0, jump_vel: 10000.0, boost: 200.0, slow: 50.0, sensitivity: 0.1, yaw: 0.0, pitch: 0.0, last_x: 0.0, last_y: 0.0})
        .with(collider)
